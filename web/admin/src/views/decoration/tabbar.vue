...
const getData = async () => {
    ...
    tabbar.list = data.list.map((item: any) => ({
        ...
        //TODO
        selected: item.selected.includes('uploads')
            ? appStore.config.ossDomain + '/' + item.selected
            : appStore.config.ossDomain + '/uploads' + item.selected,
        unselected: item.unselected.includes('uploads')
            ? appStore.config.ossDomain + '/' + item.unselected
            : appStore.config.ossDomain + '/uploads' + item.unselected
