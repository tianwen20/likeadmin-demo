...
from work.admin.schemas.setting import SettingDictTypeOut, SettingDictTypeListIn, SettingDictTypeAddIn, \
...
from work.models.setting import settings_dict_type, settings_dict_data
