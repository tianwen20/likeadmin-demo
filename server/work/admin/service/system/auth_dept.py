...
from work.admin.schemas.system import SystemAuthDeptAddIn, SystemAuthDeptEditIn, SystemAuthDeptOut, SystemAuthDeptListIn
from work.dependencies.database import db
from work.models import system_auth_dept
