...
from work.admin.schemas.article import ArticleEditIn, ArticleChangeIn, ArticleDeleteIn, ArticleListIn, ArticleDetailIn, \
    ArticleDetailOut, \
    ArticleListOut, ArticleAddIn
from work.dependencies.database import db
from work.models.article import article_table, article_cate_table
