...
from work.admin.schemas.common import CommonAlbumOut, CommonAlbumListIn, CommonAlbumCateListIn, CommonAlbumCateDelIn, \
    CommonAlbumRenameIn, CommonAlbumCateEditIn, CommonAlbumMoveIn, CommonAlbumDelIn
from work.admin.service.common.album import IAlbumService, AlbumService
from work.admin.service.common.index import IIndexService, IndexService
from work.admin.service.common.upload import IUploadService, UploadService
from work.dependencies.log import record_log, RequestType
